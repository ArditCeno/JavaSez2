...
public class Ush5Shtepia extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        catia.moveTo(200, 200);
        catia.lineTo(350, 100);
        catia.lineTo(500, 200);
        catia.closePath();
        g2d.fill(catia);
        g2d.setColor(Color.BLACK);
        g2d.draw(catia);
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Programi per Vizatimin e Shtepis");
        Lab4.Ush5Shtepia paneli = new Lab4.Ush5Shtepia();
